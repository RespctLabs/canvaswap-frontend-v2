...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and RESPCT pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and RESPCT pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from RESPCT pool', data)
  }
