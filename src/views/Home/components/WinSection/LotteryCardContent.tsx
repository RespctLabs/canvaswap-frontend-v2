...
import { Flex, Text, Skeleton, Button, ArrowForwardIcon } from '@respctclub/uikit'
...
const LotteryCardContent = () => {
  ...
  const cakePrizesText = t('%cakePrizeInUsd% in RESPCT prizes this round', { cakePrizeInUsd: cakePriceBusdAsString })
    ...
    <>
      <Flex flexDirection="column" mt="48px">
        ...
        <Text color="white" mb="40px">
          {t('Buy tickets with RESPCT, win RESPCT if your numbers match')}
        </Text>
      </Flex>
