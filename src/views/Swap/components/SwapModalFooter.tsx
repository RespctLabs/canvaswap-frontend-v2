...
import { Trade, TradeType } from '@respctclub/sdk'
import { Button, Text, AutoRenewIcon } from '@respctclub/uikit'
            ...
            <QuestionHelper
              text={
                <>
                  ...
                  <Text>- {t('%amount% towards RESPCT buyback and burn', { amount: '0.05%' })}</Text>
                </>
              }
              ml="4px"
            />
