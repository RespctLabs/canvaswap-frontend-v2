...
import { Flex, Text } from '@respctclub/uikit'
      ...
      <StyledCardWrapper>
        <RulesCard title={t('Trade to increase your rank')}>
          <Text textAlign="center" fontSize="14px" color="textSubtle">
            {t(
              'Eligible pairs: SANTOS/MATIC, PORTO/MATIC, LAZIO/MATIC, SANTOS/BUSD, PORTO/BUSD, LAZIO/BUSD, RESPCT/MATIC and RESPCT/BUSD',
            )}
          </Text>
        </RulesCard>
