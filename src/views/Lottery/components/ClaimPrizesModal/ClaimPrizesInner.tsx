...
import { Flex, Button, Text, AutoRenewIcon, PresentWonIcon } from '@respctclub/uikit'
      ...
      if (receipt.status) {
        toastSuccess(
          ...
          <ToastDescriptionWithTx txHash={receipt.transactionHash}>
            {t('Your RESPCT prizes for round %lotteryId% have been sent to your wallet', { lotteryId })}
